...
for index in range(len(read_N2DL_HeLa_img)):
    ...
    hausdorff = evaluation.hausdorff(segmented_N2DL_HeLa, read_N2DL_HeLa_gt[index])
...
for index in range(len(read_N2DH_GOWT1_img)):
    ...
    hausdorff = evaluation.hausdorff(segmented_N2DH_GOWT1, read_N2DH_GOWT1_gt[index])
...
for index in range(len(read_NIH3T3_img)):
    ...
    hausdorff = evaluation.hausdorff(segmented_NIH3T3, read_NIH3T3_gt[index])
